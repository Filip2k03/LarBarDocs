...
- **Online Web Viewer**: Open [app.diagrams.net](https://app.diagrams.net) and drag-and-drop the master file.
...
- [View Fullscreen Vector SVG](/diagrams/01_use_case_diagram.svg)
...
- [View Fullscreen Vector SVG](/diagrams/02_system_process_flowchart.svg)
...
- [View Fullscreen Vector SVG](/diagrams/03_database_erd_schema.svg)
...
- [View Fullscreen Vector SVG](/diagrams/04_component_architecture.svg)
...
- [View Fullscreen Vector SVG](/diagrams/05_class_domain_architecture.svg)
...
- [View Fullscreen Vector SVG](/diagrams/06_sequence_dispatch_chat.svg)
...
- [View Fullscreen Vector SVG](/diagrams/07_sequence_safety_guardian_cctv.svg)
...
- [View Fullscreen Vector SVG](/diagrams/08_sequence_payment_and_payout.svg)
...
- [View Fullscreen Vector SVG](/diagrams/09_state_machine_ride_lifecycle.svg)
...
- [View Fullscreen Vector SVG](/diagrams/10_state_machine_driver_status.svg)
...
- [View Fullscreen Vector SVG](/diagrams/11_guardian_plugin_module_architecture.svg)

---

## 12. Driver SOS Mesh & Family Guardian Architecture
<span class="badge-red">Page 12</span> • 1km to 3km Tiered Driver Mesh Alert, Covert Panic Triggers & Family Siren HUD
...
- [View Fullscreen Vector SVG](/diagrams/12_driver_sos_mesh_guardian.svg)
...
- [View Fullscreen Vector SVG](/diagrams/13_hetzner_3server_livemap.svg)
