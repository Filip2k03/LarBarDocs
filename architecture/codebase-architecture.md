...
```text
                               ...
                               ├────────────────────┬───────────────────┬───────────────┤
                               │   Passenger App  │    Driver App   │  Guardian  │
                               └─────────┬──────────┴─────────┬─────────┴───────┬───────┘
                                         │                    │                 │
                                         └────────────────────┼─────────────────┘
                                                              ▼
...
│ 2. USECASE LAYER:   RideDispatch, DriverSOSMesh (1km3km), MeterCalculation, SettlementEngine, CCTVBuffer │
...
- **`internal/usecase/`**: Implements core business logic:
  ...
  - **1.0 km to 3.0 km Emergency SOS Mesh**: Broadcasts distress events to neighboring drivers via Redis `GEORADIUS`.
