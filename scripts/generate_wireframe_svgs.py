...
def gen_passenger_01_booking():
    ...
    <g filter="url(#card-shadow)">
      ...
      <text x="56" y="434" fill="#FFE082" font-size="12">Stop 1: Bogyoke Aung San Market</text>
      <text x="352" y="434" fill="#F85A5A" font-size="12" text-anchor="end">✕</text>
...
def gen_driver_01_dashboard():
    ...
    <g filter="url(#card-shadow)">
      ...
      <text x="354" y="338" fill="#10B981" font-size="12" font-weight="700" text-anchor="end">⭐ 4.96</text>
    </g>
    ...
    <g filter="url(#card-shadow)">
      ...
      <text x="80" y="554" fill="#FFE8E8" font-size="12">1km - 3km Fellow Driver SOS Broadcast</text>
    </g>
...
def gen_driver_02_offer():
    ...
    <g filter="url(#card-shadow)">
      ...
      <text x="75" y="364" fill="#FFFFFF" font-size="10">Pickup (450m away)</text>
      <text x="290" y="258" fill="#FFFFFF" font-size="10" text-anchor="middle">Junction City</text>

      <!-- Trip Details List -->
      <circle cx="50" cy="430" r="6" fill="#10B981"/>
      <text x="68" y="434" fill="#FFFFFF" font-size="13" font-weight="700">Sule Square (450m • 2 mins away)</text>
...
def gen_driver_03_intrip_cctv():
    ...
    <circle cx="54" cy="143" r="5" fill="#FFFFFF"/>
    ...
    <g filter="url(#card-shadow)">
      ...
      <text x="354" y="498" fill="#38BDF8" font-size="12" font-weight="700" text-anchor="end">KBZPay Cashless</text>
      <text x="36" y="530" fill="#10B981" font-size="11">Waypoint 1 of 2: Bogyoke (Visited ✓)</text>
    </g>
...
def gen_driver_04_sos_mesh():
    ...
    <g filter="url(#card-shadow)">
      ...
      <text x="195" y="170" fill="#FFFFFF" font-size="13" font-weight="700" text-anchor="middle">Fellow Driver Needs Immediate Assistance!</text>
...
def gen_guardian_03_pairing_qr():
    ...
    <g filter="url(#card-shadow)">
      ...
      <!-- QR Matrix Mockup -->
      <rect x="95" y="220" width="60" height="60" fill="#000000"/>
      <rect x="105" y="230" width="40" height="40" fill="#FFFFFF"/>
      <rect x="115" y="240" width="20" height="20" fill="#000000"/>

      <rect x="235" y="220" width="60" height="60" fill="#000000"/>
      <rect x="245" y="230" width="40" height="40" fill="#FFFFFF"/>
      <rect x="255" y="240" width="20" height="20" fill="#000000"/>

      <rect x="95" y="360" width="60" height="60" fill="#000000"/>
      <rect x="105" y="370" width="40" height="40" fill="#FFFFFF"/>
      <rect x="115" y="380" width="20" height="20" fill="#000000"/>

      <!-- QR Center Shield Emblem -->
      <circle cx="195" cy="320" r="22" fill="#E5252A"/>
...
"""]
  ...
  <g transform="translate({pos_x}, {pos_y})">
    <text x="0" y="-12" fill="#FFFFFF" font-size="14" font-weight="800">#{idx+1:02d} • {title}</text>
    {inner_body}
  </g>
""")
